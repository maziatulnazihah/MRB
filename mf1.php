...
<html>
	...
	<style>
		 *{
			...
			header{
		    background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(229.jpg);
			height: auto;
		...
		<div class="box">
				...
				$sql = "SELECT * FROM mcr WHERE origin = 'Malaysian'";
				...
				<br><br>
				<a href="http://localhost/tutorial/mf.php"><input type="button" class="btn" value="BACK"></a>
