...
<html>
	...
	<style>
		 *{
			...
			header{
		    background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(240.jpeg);
			height: auto;
		...
		<div class="box">
				...
				$sql = "SELECT * FROM mcr WHERE origin = 'Korean'";
				...
				<br><br>
				<a href="http://localhost/tutorial/kf.php"><input type="button" class="btn" value="BACK"></a>
