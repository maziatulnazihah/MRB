...
<html lang="en">
	...
	<style>
			...
			header{
			background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(110.jpg);
			height: auto;
		...
		<table border= "1px">
				...
				$sql = "SELECT * FROM mcr WHERE categories = 'tea time'"; //tukar kt categories kalau nk lunch, dinner, etc...
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
						...
						echo"<a href=\"tt2.php?ID=".$row["r_id"]."\">Edit</a></br>";
						 echo"<a href=\"tt1.php?ID=".$row["r_id"]."\">Read More</a></td></tr>";
