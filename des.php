...
<html lang="en">
	...
	<style>
			...
			header{
			background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(254.jpg);
			height: auto;
		...
		<table border= "1px">
				...
				$sql = "SELECT * FROM mcr WHERE categories = 'dessert'"; //tukar kt categories kalau nk lunch, dinner, etc...
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
						...
						echo"<a href=\"des2.php?ID=".$row["r_id"]."\">Edit</a></br>";
						 echo"<a href=\"des1.php?ID=".$row["r_id"]."\">Read More</a></td></tr>";
