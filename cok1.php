...
<html>
	...
	<style>
		 *{
			...
			header{
		    background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(212.jpeg);
			height: auto;
		...
		<div class="box">
				...
				$sql = "SELECT * FROM mcr WHERE categories = 'cookies'";
				...
				<br><br>
				<a href="http://localhost/tutorial/cok.php"><input type="button" class="btn" value="BACK"></a>
