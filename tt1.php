...
<html>
	...
	<style>
		 *{
			...
			header{
		    background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(109.jpg);
			height: auto;
		...
		<div class="box">
				...
				$sql = "SELECT * FROM mcr WHERE categories = 'tea time'";
				...
				<br><br>
				<a href="http://localhost/tutorial/tt.php"><input type="button" class="btn" value="BACK"></a>
