...
<html lang="en">
	...
	<style>
			...
			header{
			background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(245.jpg);
			height: auto;
		...
		<table border= "1px">
				...
				$sql = "SELECT * FROM mcr WHERE origin = 'Arabian'"; //tukar kt categories kalau nk lunch, dinner, etc...
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
                        ...
                        $image_src = "image/".$image;
						 ...
						 echo"<a href=\"af2.php?ID=".$row["r_id"]."\">Edit</a></br>";
						 echo"<a href=\"af1.php?ID=".$row["r_id"]."\">Read More</a></td></tr>";
