...
<html>
	...
	<style>
		 *{
			...
			header{
			background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(255.jpg);
			height: auto;
		...
		<div class="box">
			...
			if(mysqli_num_rows($result)>0){
				...
				<br><br>
				<a href="http://localhost/tutorial/des.php"><input type="button" class="btn" value="BACK"></a>
