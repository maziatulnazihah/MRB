...
<html lang="en">
	...
	<style>
			...
			header{
			background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(124.jpg);
			height: auto;
		...
		<div class="box">
				...
				$sql = "SELECT * FROM mcr WHERE categories = 'drink&juices'"; //tukar kt categories kalau nk lunch, dinner, etc...
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
						...
						echo "<td>" . $row["title"]."</td><td>" .$row["duration"]. "</td><td>". $row["serving"]."</td><td>";
						 echo"<a href=\"daj2.php?ID=".$row["r_id"]."\">Edit</a></br>";
						 echo"<a href=\"daj1.php?ID=".$row["r_id"]."\">Read more</a></td></tr>";
