...
<html>
	...
	<style>
		 *{
			...
			header{
		    background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(250.jpg);
			height: auto;
		...
		<div class="box">
				...
				$sql = "SELECT * FROM mcr WHERE origin = 'Vietnamese'";
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
                        ...
                        $image_src = "image/".$image;
						 ...
						 echo "<tr><img src=".$image_src." width='300' height='300' ></tr><br><br><br><br>";
				...
				<br><br>
				<a href="http://localhost/tutorial/vf.php"><input type="button" class="btn" value="BACK"></a>
		
				<a href="http://localhost/tutorial/origin.php"><input type="button" class="btn" value="CANCEL"></a>
		</div>
		</center>
		</header>
