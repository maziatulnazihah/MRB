...
<html>
	...
	<style>
		 *{
			...
			header{
			background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(202.png);
			height: auto;
		...
		<div class="box">
				...
				$sql = "SELECT * FROM mcr WHERE categories = 'lunch'"; 
				...
				<br><br>
				<a href="http://localhost/tutorial/ln.php"><input type="button" class="btn" value="BACK"></a>
